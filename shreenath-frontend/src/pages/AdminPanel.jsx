...
function AdminPanel() {
  ...
  const [pinForm, setPinForm] = useState({ pincode: "", city: "", state: "", baseCharge: 40, perKgCharge: 199, active: true });
              ...
              <section className="admin-panel-card">
                ...
                <div className="shipping-pin-form">
                  ...
                  <div className="shipping-pin-form-actions">
                    <button
                      ...
                      onClick={async () => {
                        ...
                        try {
                          ...
                          setPinForm({ pincode: "", city: "", state: "", baseCharge: 40, perKgCharge: 199, active: true });
                    ...
                    {editingPinId && (
                      <button className="secondary-btn" onClick={() => { setEditingPinId(null); setPinForm({ pincode: "", city: "", state: "", baseCharge: 40, perKgCharge: 199, active: true }); }}>
                        Cancel
                      </button>
                    )}
                  </div>
